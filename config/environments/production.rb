Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'https://yielding-punishment.surge.sh', 'http://yielding-punishment.surge.sh', 'https://live-initiative-tracker.herokuapp.com', 'http://live-initiative-tracker.herokuapp.com' ]
